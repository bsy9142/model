...
;  fn_shape_path_in = filepath('BEST_6H_C_1949_0001_0000_0000_Carmen.shp',root_dir = $
;    root_dir, subdirectory = ['dat'])
...
;          -- Change an value of ACE to different values and output modificated BEST_C file.　
